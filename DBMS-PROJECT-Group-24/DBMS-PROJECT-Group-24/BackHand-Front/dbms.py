...
con = c.connect(host="localhost", user="root",
                passwd="root", database="onlinebankingsystem")
...
if  selected == "Home":
    ...
    with st.container():
        ...
        local_css("E:\Projects\DBMS-PROJECT-Group-24\DBMS-PROJECT-Group-24\BackHand-Front\style\style.css")
...
st.sidebar.image("DBMS-PROJECT-Group-24\\BackHand-Front\\bnk.jpg", use_column_width=True)